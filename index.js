...
const bot = new Telegraf('6962780680:AAG6hdOPCFb0XxKZ6udjmmeDP_Eih9g6om8');
...
async function testeTelegramAPI() {
    try {
        const response = await fetch(`https://api.telegram.org/bot6962780680:AAG6hdOPCFb0XxKZ6udjmmeDP_Eih9g6om8/getMe`, { timeout: 30000 });
...
async function iniciarFluxoDeConteudo(ctx) {
    ...
    const videoUrlCereja = 'https://video.gumlet.io/66180b4d8ec2efeb9164568c/67f88086df3c0da15868de58/download.mp4';
    const captionCereja = `Você finalmente encontrou meu chat secreto xuxuzinhooo 😈`;
  ...
  //      [Markup.button.callback('Comprar por R$ 57', 'Cereja')]
    ...
    const videoUrlPessego = 'https://video.gumlet.io/66180b4d8ec2efeb9164568c/67f88196b6d587c54ae630ac/download.mp4';
